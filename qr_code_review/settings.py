"""
Django settings for qr_code_review project.
...
SECRET_KEY = 'django-insecure-t$ch(i3di3f8%y=5cs*w&gl(v6%1(#m&1cmi!w^7@+0uvk9v0&'
...
ROOT_URLCONF = 'qr_code_review.urls'
...
WSGI_APPLICATION = 'qr_code_review.wsgi.application'
